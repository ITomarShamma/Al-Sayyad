...
class CouponAdmin(admin.ModelAdmin):
    ...
    def state(self, obj):
        ...
        if not obj.is_active:
            return format_html('<b style="color:#5A6472;">● موقوف</b>')
...
class DeliveryZoneAdmin(admin.ModelAdmin):
    ...
    def fee_state(self, obj):
        ...
        return format_html('<span style="color:#0E7C90;">● {} ل.س</span>', obj.fee_display)
...
STATUS_COLORS = {
    ...
    Order.Status.SHIPPED: "#0E7C90",     # قيد التوصيل — أساسي
...
class OrderAdmin(admin.ModelAdmin):
    ...
    def status_display(self, obj):
        color = STATUS_COLORS.get(obj.status, "#5A6472")
