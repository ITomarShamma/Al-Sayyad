...
متجر إلكتروني للسوق السوري — عربي أولاً (RTL) **مع إنجليزية كاملة** (مبدّل لغة بالفوتر).
...
- 👤 حسابات بالموبايل (زائر/زبون/تاجر/موظفون بأدوار) ولوحة تحكم بهوية البراند
- 🌐 عربي RTL + إنجليزي LTR كاملان — الترجمة عبر gettext (`scripts/translate_en.py`)
